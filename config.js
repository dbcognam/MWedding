...
export const WEDDING_DATE = "2025년 09월 25일, 토요일 오전 12시 10분";
export const WEDDING_LOCATION = "웨스턴 베니비스 신도림, 7층 다이너스티홀";

export const GROOM_NAME = "신랑 전용남";
export const GROOM_ACCOUNT_NUMBER = "신한은행 110-2609739-42";
...
export const BRIDE_NAME = "신부 김성희";
